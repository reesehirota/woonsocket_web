...
leaflet(height = 650, width = "100%") %>%
  ...
  addCircleMarkers(data = events,
                   ...
                   color = events$color,
                   fillOpacity = 0.5,
                   group = "[Bonus] Seasonal events at public parks") %>%
  ...
  addLayersControl(position = "topright",
                   overlayGroups = c("Tree Equity Score", "Public parks", "RIDOT bike paths", "RIPTA bus stops", "[Bonus] Seasonal events at public parks"),
  ...
  hideGroup("[Bonus] Seasonal events at public parks")
```
:::
